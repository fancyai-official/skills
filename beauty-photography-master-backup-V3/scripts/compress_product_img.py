...
# -*- coding: utf-8 -*-
"""
Product Image Compressor — compress local product images for efficient Claude vision analysis.

Resizes images to fit within 1024x1024, converts to JPEG (quality 100),
and progressively shrinks if the file exceeds 1 MB.

Usage:
  python3 compress_product_img.py --images "/local/path.jpg"
  python3 compress_product_img.py --images "/local/path1.jpg" "/local/path2.jpg"
